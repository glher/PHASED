...
from pgm.base import UndirectedGraph
from pgm.factors.discrete import factor_product, DiscreteFactor
from pgm.independencies import Independencies
from pgm.extern.six.moves import map, range, zip
...
class MarkovModel(UndirectedGraph):
    ...
    **Shortcuts:**
    ...
    def add_factors(self, *factors):
        ...
        Parameters
        ----------
        *factor: pgm.factors.factors object
