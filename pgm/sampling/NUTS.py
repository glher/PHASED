...
from pgm.sampling import HamiltonianMCDA
from pgm.sampling import LeapFrog
...
class NoUTurnSampler(HamiltonianMCDA):
    ...
    Example:
    --------
    >>> from pgm.sampling import NoUTurnSampler as NUTS, LeapFrog, GradLogPDFGaussian
    ...
    def sample(self, initial_pos, num_samples, stepsize=None):
        ...
        >>> from pgm.inference.continuous import NoUTurnSampler as NUTS, GradLogPDFGaussian, LeapFrog
    ...
    def generate_sample(self, initial_pos, num_samples, stepsize=None):
        ...
        Examples
        ---------
        >>> from pgm.sampling import NoUTurnSampler as NUTS, GradLogPDFGaussian
        >>> from pgm.factors.continuous import JointGaussianDistribution as JGD
        >>> import numpy as np
        >>> mean = np.array([11, -6])
...
class NoUTurnSamplerDA(NoUTurnSampler):
    ...
    Example:
    --------
    >>> from pgm.sampling import NoUTurnSamplerDA as NUTSda, GradLogPDFGaussian
    >>> from pgm.factors.continuous import JointGaussianDistribution as JGD
    >>> import numpy as np
    ...
    def sample(self, initial_pos, num_adapt, num_samples, stepsize=None):
        ...
        ---------
        >>> # If environment has a installation of pandas
        >>> from pgm.sampling import NoUTurnSamplerDA as NUTSda, GradLogPDFGaussian, LeapFrog
        >>> from pgm.factors.continuous import JointGaussianDistribution as JGD
        >>> import numpy as np
        >>> mean = np.array([10, -13])
