...
class Independencies(object):
    ...
    def contains(self, assertion):
        ...
        Examples
        --------
        >>> from pgm.independencies import Independencies, IndependenceAssertion
    ...
    def closure(self):
        ...
        # since X⟂Y|Z == Y⟂X|Z in pgm, sg0 (symmetry) is not used as an axiom/rule.
...
class IndependenceAssertion(object):
    ...
    Examples
    --------
    >>> from pgm.independencies import IndependenceAssertion
