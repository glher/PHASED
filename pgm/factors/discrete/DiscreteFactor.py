...
from pgm.factors.base import BaseFactor
from pgm.extern import tabulate
from pgm.extern import six
from pgm.extern.six.moves import map, range, reduce, zip
from pgm.utils import StateNameInit, StateNameDecorator
...
class DiscreteFactor(BaseFactor):
    ...
    def divide(self, phi1, inplace=True):
        ...
        # If factor division 0/0 = 0 but is undefined for x/0. In pgm we are using
...
def factor_product(*args):
    ...
    Examples
    --------
    >>> from pgm.factors.discrete import DiscreteFactor, factor_product
    >>> phi1 = DiscreteFactor(['x1', 'x2', 'x3'], [2, 3, 2], range(12))
    >>> phi2 = DiscreteFactor(['x3', 'x4', 'x1'], [2, 2, 2], range(8))
...
def factor_divide(phi1, phi2):
    ...
    Examples
    --------
    >>> from pgm.factors.discrete import DiscreteFactor, factor_divide
    >>> phi1 = DiscreteFactor(['x1', 'x2', 'x3'], [2, 3, 2], range(12))
    >>> phi2 = DiscreteFactor(['x3', 'x1'], [2, 2], range(1, 5))
