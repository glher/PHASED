...
from pgm.utils import StateNameInit
from pgm.utils import StateNameDecorator
...
class TabularCPD(DiscreteFactor):
    ...
    def get_cpd(self):
        """
        Returns the cpd
        >>> from pgm.factors import TabularCPD
...
#
#         >>> from pgm.factors import TreeCPD, DiscreteFactor
...
#             p6: <A_1, B_1, C_1; 0.1>
#
#         >>> from pgm.factors import RuleCPD
