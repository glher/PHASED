...
from pgm.readwrite import ProbModelXMLReader, ProbModelXMLWriter, get_probmodel_data
from pgm.models import BayesianModel
from pgm.factors.discrete import TabularCPD
from pgm.extern.six.moves import range
...
class TestProbModelXMLmethods(unittest.TestCase):
    ...
    def test_get_probmodel_data(self):
        ...
        with open('pgm/tests/test_readwrite/testdata/test_probmodelxml_data.json') as data_file:
