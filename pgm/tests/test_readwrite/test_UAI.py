...
from pgm.readwrite import UAIReader, UAIWriter
from pgm.models import BayesianModel, MarkovModel
from pgm.factors.discrete import TabularCPD, DiscreteFactor
...
12
 ...
 2.0000 2.0000 3.4000"""
        ...
        self.reader_file = UAIReader('pgm/tests/test_readwrite/testdata/grid4x4.uai')
