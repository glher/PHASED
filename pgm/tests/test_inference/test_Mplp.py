...
from pgm.inference.mplp import Mplp
from pgm.readwrite import UAIReader


class TestMplp(unittest.TestCase):
    def setUp(self):

        reader_file = UAIReader('pgm/tests/test_readwrite/testdata/grid4x4_with_triplets.uai')
