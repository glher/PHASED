...
from pgm.extern.six.moves import range, zip
...
class TestMarkovChain(unittest.TestCase):
    ...
    @patch("pgm.models.MarkovChain._check_state", autospec=True)
    ...
    @patch.object(sys.modules["pgm.models.MarkovChain"], "warn")
    def test_add_variable_existing(self, warn):
        model = MC(['p'], [2])
        model.add_variable('p', 3)
        self.assertEqual(warn.call_count, 1)

    @patch("pgm.models.MarkovChain.add_variable", autospec=True)
    ...
    @patch("pgm.models.MarkovChain.random_state", autospec=True)
    ...
    @patch("pgm.models.MarkovChain.sample", autospec=True)
    ...
    @patch.object(sys.modules["pgm.models.MarkovChain"], "sample_discrete")
