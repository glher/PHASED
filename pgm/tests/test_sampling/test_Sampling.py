...
from pgm.factors.discrete import DiscreteFactor, TabularCPD, State
from pgm.models import BayesianModel, MarkovModel
from pgm.sampling import BayesianModelSampling, GibbsSampling
...
class TestBayesianModelSampling(unittest.TestCase):
    ...
    @patch("pgm.sampling.BayesianModelSampling.forward_sample", autospec=True)
...
class TestGibbsSampling(unittest.TestCase):
    ...
    @patch('pgm.sampling.GibbsSampling._get_kernel_from_bayesian_model', autospec=True)
    ...
    @patch('pgm.sampling.GibbsSampling._get_kernel_from_markov_model', autospec=True)
