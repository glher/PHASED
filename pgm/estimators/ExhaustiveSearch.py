...
from pgm.estimators import StructureEstimator
from pgm.estimators import K2Score
from pgm.utils.mathext import powerset
...
class ExhaustiveSearch(StructureEstimator):
    ...
    def all_scores(self):
        ...
        >>> import pandas as pd
        >>> import numpy as np
        >>> from pgm.estimators import ExhaustiveSearch, K2Score
